...
def upgrade() -> None:
    ...
    roles = [
        ("04033f54-855f-4396-8e54-d46b4c9186e9", "Пользователь", "Пользователь с интерфейсом по умолчанию и всеми правами", "user", "2026-01-22T11:41:30.556239"),
        ("f7ae9b7a-4ffc-4333-9beb-3735169a7db9", "Оперативный дежурный", "Отображается только текущий день. Можно ставить и снимать отметку", "duty_officer", "2026-01-22T14:46:55.133734+03:00"),
    ]
