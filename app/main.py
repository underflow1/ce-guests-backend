...
from app.api.v1 import auth, entries, users, roles, settings as settings_router, visit_goals, meeting_results
...
app.include_router(meeting_results.router, prefix="/api/v1", tags=["meeting_results"])
